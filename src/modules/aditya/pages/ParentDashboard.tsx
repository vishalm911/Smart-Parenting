...
import { getAssessments, getAiAnalysis, getRecommendations, updateRecommendationStatus, calculateSchoolReadinessScore, checkPredictiveInactivity, getMilestonesByAge } from '../services/firebaseSimulator';
