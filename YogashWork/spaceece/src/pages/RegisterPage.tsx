...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-light-cream to-light-orange flex items-center justify-center px-4 py-12">
      <motion.div
        variants={fadeInUp}
        initial="initial"
        animate="animate"
      ...
      >
        ...
        <div className="card">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold text-dark mb-2">Join SpaceECE</h1>
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 text-center">
            <button
              ...
              className="text-sm text-gray-500 hover:text-primary font-semibold underline transition-colors"
            >
